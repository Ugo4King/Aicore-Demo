...
# #define a fiunction that chose a random word from the list
# def chose_word():
...
#     #     for i in range(len(word)):
#     #         if word[i] == guess:
#     #             word_with_blank[i] = word_with_blank[:i] + guess + word_with_blank[+1:]
#     #     word_label.config(text=word_with_blank)
#     #     if "_" not in word_with_blank:
#     #         end_game("lose")
#     # else:
...
# hangman_label = tk.Label(root, font=("CourierK", 20))
